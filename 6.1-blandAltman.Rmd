...
csPlot <- ggarrange(
  csCO_BA + xlab("Means (log units)") + ylab("Clinical v OU \n Differences (log units)"), 
          #NULL,
  csCL_BA + xlab("Means (log units)") + ylab("Clinical v OSS \n Differences (log units)"), 
          #NULL,
  csLO_BA + xlab("Means (log units)") + ylab("OSS v OS \n Differences (log units)"),
          ncol = 1,
...
vaPlot <- ggarrange(
  vaCO_BA + xlab("Means (logMAR)") + ylab("Clinical v OU \n Differences (logMAR)"), 
          #NULL,
  vaCL_BA + xlab("Means (logMAR)") + ylab("Clinical v OSS \n Differences (logMAR)"), 
          #NULL,
  vaLO_BA + xlab("Means (logMAR)") + ylab("OSS v OU \n Differences (logMAR)"),
          ncol = 1,
          #heights = c(1, -0.2, 1, -0.2, 1),
          labels = c("A", "B", "C"),
          align = "hv")
