...
csBinoPlot <- ggplot(csPlotData)+
  geom_jitter(aes(y = cs, x = fullBlur, group = fullBlur, color = test), size = 2, alpha = 1)+
  stat_summary(
    aes(y = cs, x = fullBlur,
        group = test, color = test, fill = test),
    geom = "point",
    fun.y = "mean",
    size = 4,
    shape = 24
...
csBinoScaledPlot <- ggplot(csPlotData)+
  geom_jitter(aes(y = cs.s, x = fullBlur, group = fullBlur, color = test), size = 2, alpha = 1)+
  stat_summary(
...
csArranged <- ggarrange(csBinoPlot + theme(axis.title.x = element_blank(),
                                           axis.text.x = element_blank(),
                             legend.title = element_blank()), 
          csBinoScaledPlot + theme(axis.title.x = element_blank(),
                                   legend.title = element_blank())+
            scale_x_discrete(labels=c("binoBlur" = "Binocular blur", 
                                      "reducedBlur" = "Less blur \n (collapsed across monocular blur and full vision)")),
          ncol = 1, align = "v")
show(csArranged)
```

let make the plot for mono v full vision
```{r cs plot 2, eval=FALSE}
...
csMonoPlot <- ggplot(csPlotDataShort)+
  geom_jitter(aes(y = cs, x = condition, group = condition, color = test), size = 2, alpha = 1)+
  stat_summary(
...
csMonoScaledPlot <- ggplot(csPlotDataShort)+
  geom_jitter(aes(y = cs.s, x = condition, group = condition, color = test), size = 2, alpha = 1)+
  stat_summary(
  ...
  ylab("Scaled logCS (z-score grouped by test type)")+
  scale_x_discrete(limits = level_order,
                   labels=c("0" = "Full vision", 
                                      "1" = "Monocular blur"))+
  theme(axis.title.x = element_blank())+theme_bw()

csArranged2 <- ggarrange(csMonoPlot + theme(axis.text.x = element_blank(),
                             legend.title = element_blank(),
                             axis.title.x = element_blank()), 
          csMonoScaledPlot + theme(legend.title = element_blank(),
                                   axis.title.x = element_blank()),
          ncol = 1, align = "v")
show(csArranged2)
...
vaBinoPlot <- ggplot(vaPlotData)+
  geom_jitter(aes(y = va, x = fullBlur, group = fullBlur, color = test), size = 2, alpha = 1)+
  stat_summary(
    aes(y = va, x = fullBlur,
        group = test, color = test, fill = test),
    geom = "point",
...
vaBinoScaledPlot <- ggplot(vaPlotData)+
  geom_jitter(aes(y = va.s, x = fullBlur, group = fullBlur, color = test), size = 2, alpha = 1)+
  stat_summary(
...
vaArranged <- ggarrange(vaBinoPlot + theme(axis.title.x = element_blank(),
                                           axis.text.x = element_blank(),
                             legend.title = element_blank(),
                             legend.position = "none"), 
          vaBinoScaledPlot + theme(axis.title.x = element_blank(),
                                   legend.title = element_blank(),
                             legend.position = "none")+
            scale_x_discrete(labels=c("binoBlur" = "Binocular blur", 
                                      "reducedBlur" = "Less blur \n (collapsed across monocular blur and full vision)")),
...
vaMonoPlot <- ggplot(vaPlotDataShort)+
  geom_jitter(aes(y = va, x = condition, group = condition, color = test), size = 2, alpha = 1)+
  stat_summary(
...
vaMonoScaledPlot <- ggplot(vaPlotDataShort)+
  geom_jitter(aes(y = va.s, x = condition, group = condition, color = test), size = 2, alpha = 1)+
  stat_summary(
...
#show(vaMonoScaledPlot)

vaArranged2 <- ggarrange(vaMonoPlot + theme(axis.text.x = element_blank(),
                             legend.title = element_blank(),
                             axis.title.x = element_blank()), 
          vaMonoScaledPlot + theme(legend.title = element_blank(),
                                   axis.title.x = element_blank()),
          ncol = 1, align = "v")
show(vaArranged2)
...
csBottomLeft <- ggplot(csPlotDataShort)+
  geom_jitter(aes(y = cs, x = condition, group = condition, color = test), size = 2, alpha = 1)+
  stat_summary(
    aes(y = cs, x = condition,
        group = test, color = test, fill = test),
...
csBottomRight <- ggplot(csPlotDataShort)+
  geom_jitter(aes(y = cs.s, x = condition, group = condition, color = test), size = 2, alpha = 1)+
  stat_summary(
    aes(y = cs.s, x = condition,
        group = test, color = test, fill = test),
...
```{r va patchwork 4 plot, eval=FALSE}
...
vaBottomLeft <- ggplot(vaPlotDataShort)+
  geom_jitter(aes(y = va, x = condition, group = condition, color = test), size = 2, alpha = 1)+
  stat_summary(
    aes(y = va, x = condition,
        group = test, color = test, fill = test),
...
vaBottomRight <- ggplot(vaPlotDataShort)+
  geom_jitter(aes(y = va.s, x = condition, group = condition, color = test), size = 2, alpha = 1)+
  stat_summary(
    aes(y = va.s, x = condition,
        group = test, color = test, fill = test),
